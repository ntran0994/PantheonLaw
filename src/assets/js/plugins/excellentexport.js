    ...
    var ExcellentExport = (function () {
      ...
      function createDownloadLink(anchor, base64data, exporttype, filename) {
        ...
        if (window.navigator.msSaveBlob) {
          ...
          // [DD]ref:http://stackoverflow.com/questions/19327749/javascript-blob-filename-without-link
          // Create fake a element
          $a[0].href = blobUrl;
      ...
      var ee = {
        ...
        excel: function (anchor, table, name, fileName) {
          ...
          return createDownloadLink(anchor, b64, 'application/vnd.ms-excel', fileName || 'export.xls');
        },
        /** @export */
        csv: function (anchor, table, fileName, delimiter, newLine) {
          ...
          return createDownloadLink(anchor, b64, 'application/csv', fileName || 'export.csv');
        }
      };
