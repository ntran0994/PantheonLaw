$(document).ready(function () {
    initControl(materialadmin, jQuery); // pass in (namespace, jQuery)
...
function initControl(namespace, $) {
    "use strict";
    ...
    p._handleChatMessage = function (e) {
        ...
        if (e.keyCode === 13) {
            ...
            var image = $('.list-chats li img').attr('src');

            // Create html
            var html = '';
            html += '<li>';
            html += '	<div class="chat">';
            html += '		<div class="chat-avatar"><img class="img-circle" src="' + image + '" alt=""></div>';
    ...
    // =========================================================================
    namespace.Management = new Management;
}